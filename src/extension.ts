...
async function startServer(context: vscode.ExtensionContext): Promise<void> {
	...
	const clientOptions: LanguageClientOptions = {
		documentSelector: strictDocumentSelector,
...
function readMethodLabel(args: unknown[] | undefined): string | undefined {
	const first = args?.[0];
...
function readDocumentUri(args: unknown[] | undefined): string | undefined {
	const second = args?.[1];
